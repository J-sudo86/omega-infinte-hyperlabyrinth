...
def hud(s,level_idx,enemies,player,ammo,reloading,selected_weapon):
    width, height = s.get_size()
...
def viewmodel(s, bob):
    ...
    pygame.draw.rect(s, (55, 75, 95), (int(width*.30), y, int(width*.16), 115))
    pygame.draw.rect(s, (70, 100, 125), (int(width*.54), y + 18, int(width*.16), 115))
